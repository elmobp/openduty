...
class ServicenowNotifier:
    ...
    def notify(self, notification):
        ...
        if ticket is None:
            ticket = self.__create_ticket(notification,  notification.user_to_notify.email, notification.servicenow_assignment_group)
        else:
            ticket = self.__update_ticket(ticket['sys_id'], notification, notification.servicenow_assignment_group)
