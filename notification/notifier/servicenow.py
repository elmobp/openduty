...
class ServicenowNotifier:
    ...
    def notify(self, notification):
        ...
        if ticket is None:
             ...
             ticket = self.__create_ticket(service_id, notification.message,  notification.user_to_notify.profile.first_name + " " +  notification.user_to_notify.profile.last_name, notification.user_to_notify.profile.servicenow_assignment_group)
        else:
