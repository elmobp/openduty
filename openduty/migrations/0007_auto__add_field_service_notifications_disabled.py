...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Service.notifications_disabled'
        db.add_column(u'openduty_service', 'notifications_disabled',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Service.notifications_disabled'
        db.delete_column(u'openduty_service', 'notifications_disabled')
