...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'IncidentSilenced'
        db.create_table(u'openduty_incidentsilenced', (
        ...
        db.send_create_signal(u'openduty', ['IncidentSilenced'])


    def backwards(self, orm):
        # Deleting model 'IncidentSilenced'
        db.delete_table(u'openduty_incidentsilenced')
