...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Incident.description'
        db.alter_column(u'openduty_incident', 'description', self.gf('django.db.models.fields.CharField')(max_length=200))

    def backwards(self, orm):

        # Changing field 'Incident.description'
        db.alter_column(u'openduty_incident', 'description', self.gf('django.db.models.fields.CharField')(max_length=100))
    ...
    models = {
        ...
        u'openduty.userprofile': {
            ...
            'servicenow_assignment_group': ('django.db.models.fields.CharField', [], {'max_length': '512'}),
