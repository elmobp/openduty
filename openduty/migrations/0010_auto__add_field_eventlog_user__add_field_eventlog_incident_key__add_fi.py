...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'EventLog.user'
        db.add_column(u'openduty_eventlog', 'user',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, related_name='users', null=True, blank=True, to=orm['auth.User']),
                      keep_default=False)

        # Adding field 'EventLog.incident_key'
        db.add_column(u'openduty_eventlog', 'incident_key',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['openduty.Incident'], blank=True),
                      keep_default=False)

        # Adding field 'EventLog.action'
        db.add_column(u'openduty_eventlog', 'action',
                      self.gf('django.db.models.fields.CharField')(default='log', max_length='100'),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'EventLog.user'
        db.delete_column(u'openduty_eventlog', 'user_id')

        # Deleting field 'EventLog.incident_key'
        db.delete_column(u'openduty_eventlog', 'incident_key_id')

        # Deleting field 'EventLog.action'
        db.delete_column(u'openduty_eventlog', 'action')
    ...
    models = {
        ...
        u'openduty.eventlog': {
            ...
            'action': ('django.db.models.fields.CharField', [], {'default': "'log'", 'max_length': "'100'"}),
            'data': ('django.db.models.fields.TextField', [], {}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'incident_key': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['openduty.Incident']", 'blank': 'True'}),
            ...
            'user': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'related_name': "'users'", 'null': 'True', 'blank': 'True', 'to': u"orm['auth.User']"})
        },
        u'openduty.incident': {
        ...
        u'openduty.incidentsilenced': {
            'Meta': {'object_name': 'IncidentSilenced'},
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
